<div class="modal fade" data-bs-backdrop="static" id="photoModal" tabindex="-1" aria-labelledby="photoModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="height: 500px">
            ...
            <div class="modal-body tab-content d-flex justife-content-center align-items-center">
                <div class="tab-pane fade w-100 show active" id="see-tab-pane" role="tabpanel" aria-labelledby="see-tab"
                    tabindex="0">
                ...
                <div class="tab-pane w-100 fade" id="change-tab-pane" role="tabpanel" aria-labelledby="change-tab"
                    tabindex="0">
                ...
                @can('viewPhoto', auth()->user()->about)
                    <div class="tab-pane w-100 fade" id="remove-tab-pane" role="tabpanel" aria-labelledby="remove-tab"
                        tabindex="0">
                        <div class="fz-16 d-flex justify-content-center flex-column align-items-center">
                            <div class="photo__info pb-3">
                                <div class="info__description text-center">Удаленная фотография будет сменена на:
                                </div>

                            </div>
                            <div class="rounded-circle position-relative overflow-hidden">
                                <img width="200px" src="{{ asset('photos/empty_profile.png') }}" alt="">
                            </div>
