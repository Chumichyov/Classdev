...
<div class="modal modal-lg fade" id="sendModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="sendModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taskModalLabel">Сдать</h5>
